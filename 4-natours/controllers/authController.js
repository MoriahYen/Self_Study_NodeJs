...
// const dotenv = require('dotenv'); // [Moriah] 到底要不要加?
...
// [Moriah] 不用catchAsync，因為沒有要catch error
exports.isLoggedIn = async (req, res, next) => {
  if (req.cookies.jwt) {
    try {
      ...
      res.locals.user = currentUser; // [Moriah] pug可以獲得response，像是用render function將data傳到template
      return next();
    } catch (err) {
      return next();
    }
